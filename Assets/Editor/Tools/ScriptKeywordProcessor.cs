...
internal sealed class ScriptKeywordProcessor : UnityEditor.AssetModificationProcessor
{
    ...
    private const string company1 = "";
    private const string websiteUrl1 = "";
    private const string authorName = "Alexander - twitter.com/wobes_1";
    ...
    public static void OnWillCreateAsset(string path)
    {
        ...
        file = file.Replace("#DEVELOPERNAME#", authorName);
